  ...
  return (
    <>
      <SEO
        ...
        additionalMeta={
          <>
            <meta name="keywords" content="Lebanese ARC, Lebanese respiratory care, LARC, lung health Lebanon, respiratory therapy Lebanon, Lebanese Association for Respiratory Care" />
            <script
      ...
      {/* Featured Campaign */}
      <section role="region" aria-labelledby="breathe-better-title" className="bg-white px-4 sm:px-6 py-14 md:py-20">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center">

          <div className="animate-fadeInUp">
            <h2 id="breathe-better-title" className="text-blue-800 text-3xl md:text-4xl font-extrabold mb-5 flex items-center gap-3">
      ...
      {/* What We Do */}
      <section role="region" aria-labelledby="what-we-do-heading" className="py-20 bg-gray-50 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto">
          <h2 id="what-we-do-heading" className="text-3xl font-bold text-gray-800 text-center mb-12">What We Do</h2>
